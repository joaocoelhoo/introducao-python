# Crie um programa que permita ao usuário inserir o preço de várias frutas
# e, em seguida, calcule o preço total.
...
def price_fruits():
    total_price = 0
    while True:
        preco = float(input("Insira o valor da fruta:"))
        total_price += preco

        print("Valor total:", total_price)
